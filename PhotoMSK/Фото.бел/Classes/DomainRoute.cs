...
namespace Fotobel.Classes
{
    public class DomainRoute : Route
    {
        ...
        private readonly Regex _tokenRegex =
            new Regex(@"({[a-zA-Zà-ÿÀ-ß0-9_]*})*-?\.?\/?({[a-zA-Zà-ÿÀ-ß0-9_]*})*-?\.?\/?({[a-zA-Zà-ÿÀ-ß0-9_]*})*-?\.?\/?({[a-zA-Zà-ÿÀ-ß0-9_]*})*-?\.?\/?({[a-zA-Zà-ÿÀ-ß0-9_]*})*-?\.?\/?({[a-zA-Zà-ÿÀ-ß0-9_]*})*-?\.?\/?({[a-zA-Zà-ÿÀ-ß0-9_]*})*-?\.?\/?({[a-zA-Zà-ÿÀ-ß0-9_]*})*-?\.?\/?({[a-zA-Zà-ÿÀ-ß0-9_]*})*-?\.?\/?({[a-zA-Zà-ÿÀ-ß0-9_]*})*-?\.?\/?({[a-zA-Zà-ÿÀ-ß0-9_]*})*-?\.?\/?({[a-zA-Zà-ÿÀ-ß0-9_]*})*-?\.?\/?");
