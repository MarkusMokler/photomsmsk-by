...
(function (window, document) {
    ...
    Croppic.prototype = {
        ...
        init: function () {
            ...
            that.objW = that.options.width;
            that.objH = that.options.height;
        ...
        bindImgUploadControl: function () {
            ...
            var formHtml = '<form class="' + that.id + '_imgUploadForm"  style = "position: absolute; visibility: hidden; top:0;" >  <input type="file" name="img">  </form>';//style="display: none; visibility: hidden;"
        ...
        crop: function () {
            ...
            $.ajax({
                ...
                if (that.options.onAfterImgCrop) that.options.onAfterImgCrop.call(that, data);
